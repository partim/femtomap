//! The abstract syntax tree of the feature definition language.
//!
//! This module does the parsing of data into that tree. Evaluation of the
//! tree is then implemented on the structures defined here in the
//! [`eval`][super::eval] module.
//!
//! Each type herein corresponds to a syntactical element of the grammar. See
//! the types themselves for their definition. The root of the syntax tree is
//! the [`StatementList`] type.
